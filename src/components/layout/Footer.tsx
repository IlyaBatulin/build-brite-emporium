        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/catalog" className="text-gray-600 hover:text-brand">
                  Каталог
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/delivery" className="text-gray-600 hover:text-brand">
                  Доставка
                </Link>
              </li>
              <li>
                <Link to="/contacts" className="text-gray-600 hover:text-brand">
                  Контакты
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/catalog/lumber" className="text-gray-600 hover:text-brand">
                  Пиломатериалы
                </Link>
              </li>
              <li>
                <Link to="/catalog/building-materials" className="text-gray-600 hover:text-brand">
                  Стройматериалы
                </Link>
              </li>
              <li>
                <Link to="/catalog/hardware" className="text-gray-600 hover:text-brand">
                  Метизы
                </Link>
              </li>
              <li>
                <Link to="/catalog/tools" className="text-gray-600 hover:text-brand">
                  Инструменты
                </Link>
              </li>
              <li>
                <Link to="/catalog/paints" className="text-gray-600 hover:text-brand">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  ул. Строительная, 123, г. Москва
                </span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-brand mr-2" />
                <a href="tel:+74951234567" className="text-gray-600 hover:text-brand">
                  +7 (495) 123-45-67
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-brand mr-2" />
                <a href="mailto:info@vybor-plus.ru" className="text-gray-600 hover:text-brand">
                  info@vybor-plus.ru
                </a>
              </li>
            </ul>
